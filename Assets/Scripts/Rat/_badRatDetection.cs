...
{
    [SerializeField] private Vector3[] ratPoints = new Vector3[4];
    ...
    void Start()
    {
        ...
        ratPoints = new[] {transform.TransformPoint(front), transform.TransformPoint(back), transform.TransformPoint(
            top), transform.TransformPoint(bottom), transform.TransformPoint(left), transform.TransformPoint(right) };
